...
void runRToZHmmbbCutFlow(TString intag=""){
  ...
  sample->addSkim("m(ll)","83000<mm_m[vh_v[vh]]&&mm_m[vh_v[vh]]<99000");
  sample->addSkim("MET","met_pt<60000");
  sample->addSkim("pT(V)","mm_pt[vh_v[vh]]>(0.4*vh_mass[vh]-100000)");
  //sample->addSkim("","");
